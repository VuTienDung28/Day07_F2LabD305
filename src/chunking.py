...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Keep the sentence-ending punctuation by splitting *after* it.  A
        # newline can also be a boundary after a full stop, as required by the
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # No useful separator remains: hard-split so the recursion always
        # terminates and the maximum chunk size is still respected.
        ...
        for piece in pieces:
            # An individual piece that is too large must use the next lower-
            # priority separator. Flush pending text first to preserve order.
